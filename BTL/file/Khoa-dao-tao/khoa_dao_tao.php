...
<body>
        ...
        <section id="menumain">
            <div class="inner">
                <nav class="navbar navbar-expand-lg nav-style">
                    ...
                    <a href="../index.html" id="small-logo"> <img src="../image/logo-sm.png" alt=""></a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent"> 
                        <ul class=" navbar-nav menu">
                            <li class="nav-item"><a href="../index.html" class="active"><i class="fas fa-home"></i></a></li>
                            ...
                            <li class="nav-item"><a class="nav_content" href="khoa_dao_tao.html">KHÓA ĐÀO TẠO</a></li>
                            <li class="nav-item"><a class="nav_content" href="dang_ki_hoc.html">ĐĂNG KÝ HỌC</a></li>
                            <li class="nav-item"><a class="nav_content" href="lich_hoc.html">LỊCH HỌC</a></li>
                            <li class="nav-item dropdown">
                                <a class=" dropdown-toggle nav_content" href="#" id="navbarDropdown" role="button"
                            ...
                            <li class="nav-item dropdown">
                                <a class=" dropdown-toggle nav_content" href="http://www.truongdaylaixethongnhat.com/ban-tin/" id="navbarDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                BẢN TIN
                            </a>
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <a href="http://www.truongdaylaixethongnhat.com/ban-tin/ban-tin-thong-nhat-1/">BẢN TIN THỐNG NHẤT</a>
                                    <a href="http://www.truongdaylaixethongnhat.com/ban-tin/kinh-nghiem-lai-xe-2/">KINH NGHIỆM LÁI XE</a>
                                    <a href="http://www.truongdaylaixethongnhat.com/ban-tin/the-gioi-o-to-4/">THẾ GIỚI Ô TÔ</a>
                                    <a href="http://www.truongdaylaixethongnhat.com/ban-tin/ban-tin-tong-hop-6/">BẢN TIN TỔNG HỢP</a>
                            </div>
                            <li class="nav-item"><a class="nav_content" href="http://www.truongdaylaixethongnhat.com/lien-he.html">LIÊN HỆ</a></li>
                        </ul>
                    </div>
                </nav>
        ...
        <div class="row">
            <div class="col-lg-8  col-sm-12">
                <div class="pagecurrent">
                    <p><a href="../index.html">Trang chủ</a> <i class="fa fa-angle-double-right"></i>Khóa đào tạo</p>
                </div>
                <div id="service">
                    <div class="list-service">
                        <div class="item"><a href="khoa-dao-tao/bang-lai-xe-hang-b1-4.html"><img
                                    src="../image/banglaiotoB1.jpg" alt="Bằng lái xe hạng B1"><span class="title">Bằng
                                    lái
                        ...
                        <div class="item"><a href="khoa-dao-tao/bang-lai-xe-o-to-hang-c-6.html"><img
                                    src="../image/banglaiotoC.jpg" alt="Bằng lái xe ô tô hạng C"><span
                                    class="title">Bằng
                                    lái xe ô tô hạng C</span></a></div>
                        <div class="item"><a href="khoa-dao-tao/bang-lai-xe-o-to-hang-d-7.html"><img
                                    src="../image/banglaiotoD.jpg" alt="Bằng lái xe ô tô hạng D"><span
                                    class="title">Bằng
                                    lái xe ô tô hạng D</span></a></div>
                        <div class="item"><a href="khoa-dao-tao/bang-lai-xe-o-to-hang-e-8.html"><img
                                    src="../image/banglaiotoE.jpg" alt="Bằng lái xe ô tô hạng E"><span
                                    class="title">Bằng
                                    lái xe ô tô hạng E</span></a></div>
                        <div class="item"><a href="khoa-dao-tao/bang-lai-xe-romoc-hang-f-9.html"><img
                                    src="../image/banglaiotoF.jpg" alt="Bằng lái xe rơ-móc hạng F"><span
                                    class="title">Bằng
                                    lái xe rơ-móc hạng F</span></a></div>
                        <div class="item"><a href="khoa-dao-tao/bang-lai-xe-gan-may-hang-a1-2.html"><img
                                    src="../image/banglaihangA1.jpg" alt="Bằng lái xe gắn máy hạng A1"><span
                                    class="title">Bằng lái xe gắn máy hạng A1</span></a></div>
                        <div class="item"><a href="khoa-dao-tao/bang-lai-xe-mo-to-hang-a2-3.html"><img
                                    src="../image/banglaihangA2.jpg" alt="Bằng lái xe mô tô hạng A2"><span
            ...
            <div class="col-lg-4  col-sm-12">
                <aside id="getbox">
                    ...
                    <form name="frmRegister" method="post" action="register.php" onSubmit="return chkRegister();">
                        <p class="rows">
                        ...
                        <p>
                            <input type="button" name="btnRegister" value="Đăng ký">
                        </p>
                    </form>
                </aside>
                <!-- button list -->
    ...
    <div>
        <div class="info-own">
            <p><b>TRƯỜNG DẠY L&Aacute;I XE THỐNG NHẤT</b><br />
                Địa chỉ 1: 91L cư x&aacute; L&yacute; Thường Kiệt, đường Nguyễn Kim, phường 7, quận 10, TPHCM.<br />

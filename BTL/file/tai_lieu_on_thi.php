        ...
        <div class="row">
            <div class="col-lg-8  col-sm-12">
                <div class="pagecurrent">
                    <p><a href="../index.php">Trang chủ</a> <i class="fa fa-angle-double-right"></i>Tài liệu ôn thi</p>
                </div>
    ...
    ?>
                <div id="service">
                    <div class="list-service">
                                <div class="item">
                                    <a href="#"><img
                                    src="../image/450cauhoitracnghiem.jpg" ><span
                                    class="title">450 câu hỏi trắc nghiệm hạng B, C – Phần 9</span></a>
                                </div>
                        <?php 
                            $sql="SELECT id from topic WHERE  name='tài liệu ôn thi'";
                        ...
                        ?>
                            <div class="item"><a href="tai_lieu_on_thi.php?id=<?php echo $row['id']; ?>"><img

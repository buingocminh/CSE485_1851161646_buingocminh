...
<body>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Kết quả: Nguyễn Văn A</h1>
            </div>
        </div>
        <!--/.row-->
        <div class="row">
                        ...
                        <div class="col-md-8">
                            ...
                            <form role="form" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="exam_name" required value="0123456789"
                                        class="form-control">
                                </div>
                                <div class="form-group">
                                    <label>Số báo danh</label>
                                    <input type="text" name="result_num" required value="05"
                                        class="form-control">
                                </div>
                                <div class="form-group">
                                    <label>lớp</label>
                                    <input type="text" name="stu_class" required value="A2-k24"
                                        class="form-control">
                                </div>
                                <div class="form-group">
                                    <label> Kết quả</label>

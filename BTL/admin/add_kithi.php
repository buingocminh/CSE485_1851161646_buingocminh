...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="ki_thi.html"><i class="far fa-file-alt fas"></i>Quản lý Thi</a></li>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Thêm kì thi</li>
			</ol>
		</div>
		<!--/.row-->
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Thêm kì thi</h1>
			</div>
		</div>
		<!--/.row-->
		<div class="row">
                        ...
                        <div class="col-md-8">
                            ...
                            <form role="form" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="exam_date" required  class="form-control"
                                        placeholder="ngày bất đầu...">
                                </div>
                                <div class="form-group">
                                    <label>lớp:</label>
                                    <input type="text" name="exam_class" required  class="form-control"
                                        placeholder="lớp...">
                                </div>
